<div class="card color-3">
	<div class="card-content grey-text text-lighten-2">
		<h3 class="card-title center">Zweiter Tag (21.06.2025)</h3>
					...
					<table class="bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td class="center">-</td>
								<td class="center indigo darken-2">Lagerfeuerromatik mit Jaster</td>
							</tr>
							...
							<tr>
								...
								<td class="center red" colspan="5">Nachtruhe</td>
							</tr>
						</tbody>
					</table>
				</div>
