<?php include_once(__DIR__ . '/../header.php'); ?>
	<main class="background-pattern">
				...
				<div class="card color-3">
					<div class="card-content white-text">
						...
						<form action="login" method="post">
							...
							<div class="row center">
								<div class="col s12">
									<a class="btn-flat waves-effect waves-light modal-trigger" data-target="forgot-password-modal">Passwort vergessen</a>
								</div>
							</div>
						</form>
					</div>
		...
		<div id="forgot-password-modal" class="modal modal-fixed-footer color-3">
